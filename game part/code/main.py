...
class Game:
	...
	def import_assets(self):
		#수정 요망 - 우리는 마을을 두 개 만드는 거니까 마을마다 저게 하나씩 있어야 함.
		#즉 현재 플레이어가 있는 마을이 뭔지를 파악하고 그 마을의 그래픽을 로딩하는 작업이 필요함
